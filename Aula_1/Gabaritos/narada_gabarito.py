...
def decrypt(base64_string, fixed_vector):
    xored_binary = base64_to_binary(base64_string)
    reversed_binary = xor_with_fixed_vector(xored_binary, fixed_vector)
    inverted_binary = reverse_binary(reversed_binary)
    binary_string = invert_binary(inverted_binary)
    input_string = binary_to_string(binary_string)
    return input_string
...
if __name__ == "__main__":
    ...
    input_crypt = input("Digite um criptografado: ")
    decrypted = decrypt(input_crypt, fixed_vector)
